...
¤ _namebot join  [Invite Bot]
¤ Bye _namebot   [Leave Bot]
"""
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            if not target in admin or Bots:
                                try:
                                    klist=[ki,kk,kc]
                                    kicker=random.choice(klist)
...
#-----------------------------------------------
            ...
            elif msg.text in ["Tr say hinata pekok"]:
            ...
            elif msg.text in ["Tr say bobo ah","Bobo dulu ah"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
	      ...
	      if msg.from_ in admin:
                cl.sendText(msg.to,"Kaneki Hadir")
                ki.sendText(msg.to,"Rize Hadir")
                kk.sendText(msg.to,"Touka Hadir")
                kc.sendText(msg.to,"Ayato Hadir")
                kd.sendText(msg.to,"Tatara Hadir")
