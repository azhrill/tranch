...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif "Tr1 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Tr1 kick ","")
					ki.kickoutFromGroup(msg.to,[midd])
            elif "Tr2 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Tr2 kick ","")
					kk.kickoutFromGroup(msg.to,[midd])
            elif "Tr3 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Tr3 kick ","")
            ...
            elif "Tr1 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Tr1 invite ","")
					ki.findAndAddContactsByMid(midd)
					ki.inviteIntoGroup(msg.to,[midd])
            elif "Tr2 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Tr2 invite ","")
					kk.findAndAddContactsByMid(midd)
					kk.inviteIntoGroup(msg.to,[midd])
            elif "Tr3 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Tr3 invite ","")
				...
				if msg.from_ in admin:
					...
					cl.sendMessage(msg)
            elif msg.text in ["Tr1"]:
				if msg.from_ in admin:
					msg.contentType = 13
					msg.contentMetadata = {'mid': Amid}
					ki.sendMessage(msg)
            elif msg.text in ["Tr2"]:
				if msg.from_ in admin:
					msg.contentType = 13
				...
				if msg.from_ in admin:
					...
					msg.text = None
					cl.sendMessage(msg)
            elif msg.text in ["æ„�1�7�ã®ãƒ�1�7�ãƒ¬ã�1�7�¼ãƒ³ãƒ˄1�7","Tr1 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					ki.sendMessage(msg)
            elif msg.text in ["æ„�1�7�ã®ãƒ�1�7�ãƒ¬ã�1�7�¼ãƒ³ãƒ˄1�7","Tr2 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kk.sendMessage(msg)
            elif msg.text in ["æ„�1�7�ã®ãƒ�1�7�ãƒ¬ã�1�7�¼ãƒ³ãƒ˄1�7","Tr3 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
            ...
            elif msg.text in ["Tr cancel","Bot cancel"]:
				if msg.from_ in admin:
					if msg.toType == 2:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,mid)
            elif "Tr1 mid" == msg.text:
				if msg.from_ in admin:
					ki.sendText(msg.to,Amid)
            elif "Tr2 mid" == msg.text:
				if msg.from_ in admin:
					kk.sendText(msg.to,Bmid)
            elif "Tr3 mid" == msg.text:
				if msg.from_ in admin:
					kc.sendText(msg.to,Cmid)
				...
				if msg.from_ in admin:
					string = msg.text.replace("Tr ","")
					if len(string.decode('utf-8')) <= 20:
						profile = cl.getProfile()
						profile.displayName = string
						cl.updateProfile(profile)
						cl.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Tr1 rename "]:
				if msg.from_ in admin:
					string = msg.text.replace("Tr1 rename ","")
					if len(string.decode('utf-8')) <= 20:
						profile_B = ki.getProfile()
						profile_B.displayName = string
						ki.updateProfile(profile_B)
						ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Tr2 rename "]:
				if msg.from_ in admin:
					string = msg.text.replace("Tr2 rename ","")
					if len(string.decode('utf-8')) <= 20:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Test hi!!")
#-----------------------------------------------
            elif "Tree say " in msg.text:
				if msg.from_ in admin:
					bctxt = msg.text.replace("Tree say ","")
